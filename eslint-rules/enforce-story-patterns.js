  ...
  meta: {
    ...
    messages: {
      noCanvasElementQuery:
        'canvasElement.{{method}} is discouraged in play functions. Use within() + role/text queries instead. Use within() + role/text queries instead.',
      noGetByInWaitFor:
        '{{method}} inside waitFor throws before retry. Use queryBy* + expect inside waitFor, or findBy* outside it. Use queryBy* + expect inside waitFor, or findBy* outside.',
    },
    schema: [],
  },
  create(context) {
