# Roles CRUD — Reference Guide

> **This is a REFERENCE GUIDE, not production code.**
> When creating a new app from this template, **replace this entire folder**
> with your own features. The patterns demonstrated here — not the code
> itself — are what you're meant to follow.
